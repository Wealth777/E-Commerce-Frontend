  ...
  return (
    <div className={`min-h-screen ${bgColor} py-12`}>
      <div className="max-w-7xl mx-auto px-4">
        <h1 className={`text-3xl font-bold ${textColor} mb-8`}>Platform Analytics</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className={`${cardBg} shadow rounded-lg p-6 text-center`}>
            <p className={isDark ? 'text-gray-400' : 'text-gray-600'}>Total Transactions</p>
            <p className="text-3xl font-bold text-blue-600">0</p>
          </div>
          <div className={`${cardBg} shadow rounded-lg p-6 text-center`}>
            <p className={isDark ? 'text-gray-400' : 'text-gray-600'}>Avg Transaction</p>
        ...
        <div className={`${cardBg} shadow rounded-lg p-6`}>
          <h3 className={`text-xl font-semibold ${textColor} mb-4`}>Revenue Trends</h3>
