    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                const response = await apiClient.post('/vendor/profile/onboarding', formData, { headers: { "Content-Type": "multipart/form-data" } });
                const serverUser = response?.data?.data || response?.data?.user || response?.data?.profile || {};
                const updatedUser = {
                    ...(user || {}),
                    ...serverUser,
            ...
            <div className="w-full max-w-3xl bg-white dark:bg-[#111625] border border-slate-200 dark:border-slate-800/80 shadow-2xl rounded-3xl p-6 sm:p-10 relative">
                ...
                <div className="mb-8 pb-6 border-b border-slate-100 dark:border-slate-800/60">
                    <div className="flex justify-between items-center mb-4">
                        <h2 className="text-xl sm:text-2xl font-bold tracking-tight">Merchant Onboarding</h2>
                        ...
                        <div className="space-y-6 animate-fadeIn">
                            <div className="flex items-start bg-blue-50 dark:bg-blue-950/30 border border-blue-100 dark:border-blue-900/50 p-4 rounded-xl mb-4">
                                ...
                                <p className="text-xs text-blue-700 dark:text-blue-300 leading-relaxed">
                                    <strong>Why we need this information:</strong> To maintain a secure marketplace ecosystem, we verify your current active enrollment status. This data links your merchant identity to your institution, preventing bad actors and building direct student-to-student network trust.
                                </p>
                            </div>
